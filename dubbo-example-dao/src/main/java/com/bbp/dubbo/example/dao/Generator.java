package com.bbp.dubbo.example.dao;

import com.bbp.dubbo.example.common.util.MybatisGeneratorUtil;
import com.bbp.dubbo.example.common.util.PropertiesFileUtil;
...
public class Generator {
	...
	// 根据命名规范，只修改此常量值即可
	private static String MODULE = "dubbo-example";
