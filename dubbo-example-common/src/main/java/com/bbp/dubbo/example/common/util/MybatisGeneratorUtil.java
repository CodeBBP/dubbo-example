package com.bbp.dubbo.example.common.util;
...
import static com.bbp.dubbo.example.common.util.StringUtil.lineToHump;
...
public class MybatisGeneratorUtil {
    ...
    public static void generator(
        ...
        try {
            ...
            // 查询定制前缀项目的所有表
            JdbcUtil jdbcUtil = new JdbcUtil(jdbc_driver, jdbc_url, jdbc_username, AESUtil.aesEncode(jdbc_password));
